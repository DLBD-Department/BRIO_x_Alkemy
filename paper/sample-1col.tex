...
We present a software application for the detection and analysis of biases in AI systems. The application is meant to help developers and data scientists that wish to test software systems relying on probabilistic and learning mechanisms in order to detect misbehaviours, collect data about them and develop the systems in order to provide less biased versions of them\dots  

The system we are presenting is based on the theoretical, foundational works presented in
%\cite{pk16}, 
\cite{dap21}, \cite{dagp22}, and \cite{gp23}.

This paper contains a presentation of the implementation of the application, a discussion of the motivation behind the definition of the system, the intuition and the formal ideas behind the implementation of the module for bias analysis, its technical description and an analysis of data obtained from an initial case study.
...
The presented tool for the detection of biases in AI systems is a part of a more complex software consisting of three, partly inter-dependent modules. The complete system will present two autonomous modules for the analysis of bias---the one just presented---and opacity of AI systems and a module depending on these two concerning risk evaluation. 
