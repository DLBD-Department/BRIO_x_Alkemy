...
%% article.
\begin{abstract}
We present a tool for the detection of biased behaviour in AI systems. Using a specific probability-based algorithm,
%typed $\lambda$-calculus, 
we provide the means to compare the results of the user's algorithm of choice on a specific feature that they deem ``sensible'' with respect to fixed classes and to a known optimal behaviour.
\end{abstract}
